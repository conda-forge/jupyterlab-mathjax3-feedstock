...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-mathjax3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12289&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-mathjax3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-mathjax3` can be installed with:

```
conda install jupyterlab-mathjax3
```

It is possible to list all of the versions of `jupyterlab-mathjax3` available on your platform with:
